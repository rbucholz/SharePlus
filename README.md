...
[Gulp](http://gulpjs.com/) is perfect for automating away these annoyances and lets you focus on coding. If you run the watch task with the gulpfile found in this directory, it will create a new distributable file every time you save your code. In the future, I hope to have it push to SharePoint as well, but for now that'll be the only repetitive step you'll need to do. 
